...
# from typing import TYPE_CHECKING, Any, Callable, Generator, Generic, Iterable, TypeVar, cast
...
# BuilderConfigBound = TypeVar("BuilderConfigBound", bound=AwsBuilderConfig)
...
#     @classmethod
#     def get_config_class(cls) -> type[AwsBuilderConfig]:
#         """
